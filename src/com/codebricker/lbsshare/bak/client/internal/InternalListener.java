...
public class InternalListener extends IInternalListener.Stub {
	...
	@Override
	public void receiveGetUserMap(String email, String phone, String userId, String nick, 
			boolean result) throws RemoteException {
	...
	@Override
	public void receiveLoginResult(String email, String userId, String nick,
			String phone, boolean result) throws RemoteException {
