...
public class HttpUtil {
	...
	public static HttpStrResponse postStr(String url,
			Map<String, String> params, Map<String, String> customHttpHeader) {
		return httpStr("POST", url, params, customHttpHeader);
	}

	public static HttpStrResponse getStr(String url,
			Map<String, String> params, Map<String, String> customHttpHeader) {
		return httpStr("GET", url, params, customHttpHeader);
	}

	public static HttpInputStreamResponse postInputSteam(String url,
			Map<String, String> params, Map<String, String> customHttpHeader) {
		return httpInputStream("POST", url, params, customHttpHeader);
	}

	public static HttpInputStreamResponse getInputSteam(String url,
			Map<String, String> params, Map<String, String> customHttpHeader) {
		return httpInputStream("GET", url, params, customHttpHeader);
	}

	private static HttpInputStreamResponse httpInputStream(String method,
			String urlStr, Map<String, String> params,
		...
		try {
			...
			java.net.Proxy javaProxy = NetUtil.getApnJavaProxy(AndroidUtil
					.getApp());
			if (javaProxy == null) {
	...
	public static HttpStrResponse httpStr(String method, String urlStr,
			Map<String, String> params, Map<String, String> customHttpHeader) {
		HttpURLConnection conn = null;
		Reader reader = null;
		StringBuilder sb = new StringBuilder();
	...
	public static class HttpInputStreamResponse extends HttpResponse {
		...
		public HttpInputStreamResponse(InputStream inputStream,
